...
if (_spawnRoll <= _spawnChance) then {
	...
	//Spawn AI
	_rndnum = round(random 2) + 2;
	_aispawn = [_position,20,5,_rndnum,0,1,10,10,2,0] execVM "\z\addons\dayz_server\compile\AI\add_unit_server.sqf";
	_aispawn = [_position,20,5,1,0,1,10,10,2,0] execVM "\z\addons\dayz_server\compile\AI\add_unit_server.sqf";
	_aispawn = [_position,20,5,1,0,1,10,10,0,0] execVM "\z\addons\dayz_server\compile\AI\add_unit_server.sqf";
