...
*/
	...
	DZAI_BanditTypes = ["INS_Soldier_MG"]; //List of skins for AI units to use

	DZAI_Backpacks0 = ["DZ_Patrol_Pack_EP1","DZ_Czech_Vest_Puch","DZ_Assault_Pack_EP1"];
	DZAI_Backpacks1 = ["DZ_Patrol_Pack_EP1","DZ_Czech_Vest_Puch","DZ_Assault_Pack_EP1","DZ_British_ACU","DZ_TK_Assault_Pack_EP1","DZ_ALICE_Pack_EP1"];
	DZAI_Backpacks2 = ["DZ_British_ACU"];
	DZAI_Backpacks3 = ["DZ_CivilBackpack_EP1"];
